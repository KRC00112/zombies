        ...
        <div className='main-management-container '>
            ...
            <div className='staff-Details'>
                ...
                <div className='member-profile-image-box'>
                    <img className={membersList.length>0 ?`member-profile-img border-5 border-solid border-white `:``}  src={membersList.length > 0 ?  import.meta.env.BASE_URL + selectedMember?.profileLocation : import.meta.env.BASE_URL + "/staff-profiles/default.png"}
